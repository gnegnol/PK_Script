...
_min_groups = 1;		// The mimimum number of groups that will be created
_max_groups = 1;		// The maximum number of groups that will be created. This number CANNOT exceed 8

_min_group_size = 4;	// The minimum number of people a group can contain
...
_max_enemy_distance = 70;	// This is the maximum distance a group can be from the player as the group follows the player around
...
_man_type=["RHS_MSV_RIFLEMAN","RHS_MSV_MACHINEGUNNER","RHS_MSV_GRENADIER","RHS_MSV_GRENADIER_RPG","RHS_MSV_medic"];
...
_group_spawn_delay_min=[60,60,60,60,60,120,120,120,120,120,120]; 
_group_spawn_delay_max=[80,120,120,80,240,240,240,240,240,240,240]; 
...
_group_skill=[0.3, 0.3, 0.4 ,0.5, 0.6, 0.7, 0.8, 0.9];
...
_all_man_odds = [_man_odds_group0, _man_odds_group1, _man_odds_group2, _man_odds_group3, _man_odds_group4, _man_odds_group5, _man_odds_group6, _man_odds_group7];
